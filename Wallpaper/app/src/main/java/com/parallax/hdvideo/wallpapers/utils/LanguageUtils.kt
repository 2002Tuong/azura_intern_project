...
import com.parallax.hdvideo.wallpapers.extension.moveItemToPosition
...
//        }
    ...
    private fun saveLocale(lang: String) {
        preferencesStorage.languageCode = lang
    }

    fun loadLocale(context: Context) {
        val languageCode: String = preferencesStorage.languageCode
        if (languageCode == "") {
