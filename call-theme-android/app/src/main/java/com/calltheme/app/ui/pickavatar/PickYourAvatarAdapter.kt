...
class PickYourAvatarAdapter(
    ...
    var removeCallback: ((avatar: AvatarModel) -> Unit)? = null
        ...
        when (holder) {
            ...
            is AvatarViewHolder -> {
                ...
                holder.removeButton.setOnClickListener {
                    this.removeCallback?.invoke(avatar)
                }
    ...
    fun onRemoveItem(callback: (avatar: AvatarModel) -> Unit) {
