package com.calltheme.app.ui.component
...
class CustomRatingBar @JvmOverloads constructor(
    ...
    init {
        ...
        val typedAttrArray = context.obtainStyledAttributes(attrs, R.styleable.CustomRatingBar, defStyleAttr, 0)
        ...
        emptyLastStarDraw = typedAttrArray.getDrawable(R.styleable.CustomRatingBar_emptyLastStarDrawable)
        filledLastStarDraw = typedAttrArray.getDrawable(R.styleable.CustomRatingBar_filledLastStarDrawable)
        starPadding = typedAttrArray.getDimensionPixelSize(R.styleable.CustomRatingBar_starSpacing, 0)
