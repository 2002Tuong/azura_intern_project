...
import com.emopass.antitheftalarm.utils.flash.FlashManager;
...
public class AlarmDuringAntiTheftManager {
    ...
    public void vibrateAntitheft() {
        if (PreferencesHelper.getBoolean(PreferencesHelper.VIBRATE_DURING_ALARM, true)) {
    ...
    private void playAudio() {
        ...
        float percentVolume = (float) PreferencesHelper.getInt(PreferencesHelper.SETTING_VALUE_SOUND, Config.DEFAULT_SOUND) / 10;
