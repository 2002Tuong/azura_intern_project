...
import com.emopass.antitheftalarm.databinding.DialogAskPermissionBinding;

public class DialogAskPermission extends BaseDialog<DialogAskPermissionBinding, DialogAskPermission.ExtendBuilder> {
    ...
    @Override
    protected DialogAskPermissionBinding getViewBinding() {
        return DialogAskPermissionBinding.inflate(LayoutInflater.from(getContext()));
    }
