...
import com.artgen.app.databinding.Medium2NativeAdViewBinding
import com.google.android.gms.ads.nativead.NativeAd

class Medium2NativeAdView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : FrameLayout(context, attrs) {

    private val binding =
        Medium2NativeAdViewBinding.inflate(LayoutInflater.from(context), this, true)
