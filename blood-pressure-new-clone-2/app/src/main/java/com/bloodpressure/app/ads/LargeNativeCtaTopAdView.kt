...
import com.bloodpressure.app.databinding.NativeCtaTopAdViewBinding
import com.google.android.gms.ads.nativead.NativeAd

class LargeNativeCtaTopAdView@JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : FrameLayout(context, attrs) {

    private val binding =
        NativeCtaTopAdViewBinding.inflate(LayoutInflater.from(context), this, true)
