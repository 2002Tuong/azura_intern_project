...
import com.bloodpressure.app.databinding.MediumNativeCtaTopAdViewBinding
import com.google.android.gms.ads.nativead.NativeAd

class MediumNativeCtaTopAdView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null
) : FrameLayout(context, attrs) {

    private val binding =
        MediumNativeCtaTopAdViewBinding.inflate(LayoutInflater.from(context), this, true)
