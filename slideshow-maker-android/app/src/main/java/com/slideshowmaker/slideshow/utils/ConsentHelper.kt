    ...
    private fun obtainConsentAndShow(context: AppCompatActivity, loadAds: () -> Unit, onDone: () -> Unit) {
        val params = if (BuildConfig.DEBUG) {
            val debugSettings = ConsentDebugSettings.Builder(context)
                ...
                .addTestDeviceHashedId("2E5CF945691095AFB0933AC1C5AB096C")
                .addTestDeviceHashedId("16442AA66EB93472304747CA4973383E")
                .addTestDeviceHashedId("E5175EC4D9B91F8C1B4D6D6F99351187")
                .addTestDeviceHashedId("1349912780114B5B63911CEBE4F4CFC4")
