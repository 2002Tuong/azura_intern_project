...
@EpoxyModelClass(layout = R.layout.epoxy_view_snap_confirm_selected_media_view)
abstract class ConfirmMediaEpoxyModel : EpoxyModelWithHolder<ConfirmMediaEpoxyModel.Holder>() {
    @EpoxyAttribute
