...
public class GlFilter {
    ...
    public GlFilter() {
        ...
        mGPUImageFilter = new GPUImageFilter(DEFAULT_VERTEX_SHADER, DEFAULT_FRAGMENT_SHADER);
    }
    ...
    public GlFilter(final Resources res, final int vertexShaderSourceResId, final int fragmentShaderSourceResId) {
        ...
        mGPUImageFilter = new GPUImageFilter(res.getString(vertexShaderSourceResId), res.getString(fragmentShaderSourceResId));
    }

    public GlFilter(final String vertexShaderSource, final String fragmentShaderSource) {
        this.vertexShaderSource = vertexShaderSource;
        this.fragmentShaderSource = fragmentShaderSource;
        mGPUImageFilter = new GPUImageFilter(vertexShaderSource, fragmentShaderSource);
    }

    public GPUImageFilter getImageFilter() {
        mGPUImageFilter.onInit();
