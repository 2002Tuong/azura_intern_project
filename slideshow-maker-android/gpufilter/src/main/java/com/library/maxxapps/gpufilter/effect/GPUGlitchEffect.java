package com.library.greensoft.gpufilter.effect;

import android.opengl.GLES20;

import jp.co.cyberagent.android.gpuimage.filter.GPUImageFilter;

public class GPUGlitchEffect extends GPUImageFilter {
    ...
    public void onInit() {
        super.onInit();
        alphaLocation = GLES20.glGetUniformLocation(getProgram(), "paramAlpha");
        dimenLocation = GLES20.glGetUniformLocation(getProgram(), "paramDimen");
        gridLocation = GLES20.glGetUniformLocation(getProgram(), "paramGrid");
        volumeLocation = GLES20.glGetUniformLocation(getProgram(), "paramVolume");
    }

    @Override
    public void onInitialized() {
        super.onInitialized();
        setFloat(alphaLocation, paramAlpha);
        setFloatVec2(dimenLocation, paramDimen);
        setFloat(gridLocation, paramGrid);
        setFloat(volumeLocation, paramVolume);
    }
}
