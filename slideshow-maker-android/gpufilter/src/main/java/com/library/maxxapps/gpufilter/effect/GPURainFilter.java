...
public class GPURainFilter extends GPUImageFilter {
    ...
    private int inTentsityLocation;
    ...
    public void onInit() {
        super.onInit();
        inTentsityLocation = GLES20.glGetUniformLocation(getProgram(), "paramIntensity");
    ...
    public void onDraw(int textureId, FloatBuffer cubeBuffer, FloatBuffer textureBuffer) {
        ...
        setFloat(inTentsityLocation, paramIntensity);
